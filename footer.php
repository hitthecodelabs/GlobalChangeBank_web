</div> <!-- Cierra la etiqueta <div class="l-canvas..."> del header.php -->
        
        <!-- ============================================================================== -->
        <!-- INICIO DE LA ESTRUCTURA DEL FOOTER -->
        <!-- ============================================================================== -->
            ...
            <div class="site-footer__footer">
                <div class="container-fluid">
                    <ul>
                        ...
                        <li><a href="#" title="Career Center" target="_blank">Career Center</a></li>
                    </ul>
                </div>
            </div>
        </footer>
        <!-- ============================================================================== -->
        <!-- FIN DE LA ESTRUCTURA DEL FOOTER -->
        <!-- ============================================================================== -->

    </div> <!-- Cierra la etiqueta <div class="l-surround"> del header.php -->

    <div class="main-nav-backdrop"></div>

    <!-- ============================================================================== -->
    <!-- SCRIPTS FINALES (Cargan al final para mejorar el rendimiento) -->
    <!-- ============================================================================== -->
    
    <!-- Scripts externos (se dejan como están) -->
    <script src="https://www.youtube.com/iframe_api"></script>
    <script src="https://cdn.jsdelivr.net/npm/swiper@11.0.6/swiper-bundle.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/js-cookie@3.0.5/dist/js.cookie.min.js"></script>
    
    <!-- Script principal del tema (ruta corregida) -->
    <script src="/assets/gcb_theme/js/main.min.js" type="module"></script>
    
    <!-- Script de analítica (externo, se deja como está) -->
